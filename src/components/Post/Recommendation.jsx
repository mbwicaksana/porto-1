...
const Recommendation = () => {
  return (
    <>
      <div className="m-5 text-start text-xl font-bold text-slate-200  sm:text-3xl">
        You Might Also Like
      </div>
      <div className="mx-5 my-5 grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
        <div className="card border border-accent-secondary bg-base-100 shadow-xl">
          <img
