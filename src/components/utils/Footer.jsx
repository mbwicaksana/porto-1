      ...
      <footer className="bg-primary-dark bg-gradient-to-b from-primary-light to-transparent">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <ul className="mt-12 flex justify-center gap-6 md:gap-8">
            <li>
              <a
                href="https://www.facebook.com/muhammad.bayu"
                rel="noreferrer"
                target="_blank"
            ...
            <li>
              <a
                href="https://www.instagram.com/mbwicaksana/"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
              >
            ...
            <li>
              <a
                href="https://wa.me/+62895365570365"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
              >
            ...
            <li>
              <a
                href="https://github.com/mbwicaksana"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
              >
            ...
            <li>
              <a
                href="mailto:bayu@windelov.my.id"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
              >
