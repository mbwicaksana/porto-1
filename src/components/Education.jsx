  ...
  return (
    <>
      <div className="bg-beauty-blue-lighter py-12 lg:py-24 px-12 lg:px-24">
        ...
        <h1 className="text-xl lg:text-5xl font-bold text-center mb-12 lg:mb-24">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8 mb-4 lg:mb-20 ">
          <div className="h-max">
            ...
            <div className="mt-5 mb-2 text-3xl font-medium lg:font-bold">
              Internal Auditor
            </div>
            <div className="font-light lg:font-semibold mb-8 lg:mb-auto">
